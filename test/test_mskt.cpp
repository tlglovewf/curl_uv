...
int main(int argc, char **argv)
{
  ...
  if(argc < 2)
  {
    add_download("http://fs.navinfo.com/smapapi/parking/mapV/data/vector?dataSource=Parkingmore&z=18&x=215770&y=99258",1);
  }
  else
  {
    while(argc-- > 1) {
      std::cout << "download file -> " << argv[argc] << std::endl;
